...
int main(int argc, const char * argv[]) {
    ...
    //Aufgabe c)
    student students[3];
    students[0] = { .id = 123, .name = "Philip J. Fry", .studiengang = "TMM", .note = 5.0, .bestanden = false};
    students[1] = { .id = 456, .name = "Hubert J. Farnsworth", .studiengang = "E-Technik", .note = 1.0, .bestanden = true};
    students[2] = { .id = 789, .name = "John Zoidberg", .studiengang = "soziale Arbeit", .note = 4.0, .bestanden = true};
    
    student student4, student5;
    
    student4.id = 252;
    student4.name = "Bender B. Rodriguez";
    student4.studiengang = "Maschinenbau";
    student4.note = 4.0;
    student4.bestanden = true;
    
    student5.id = 438;
    student5.name = "Amy Wong";
    student5.studiengang = "BWL";
    student5.note = 5.0;
